...
#    --save exp20_ip_rnn_10min_r1-p2-h2_rmin65_ru64_bs512 --rnn_hiddens 64 --port_hiddens 16 8 --hiddens 32 --batch_size 512 --n_epoch 500 --lr 0.0001 --regress_min 65
...
#           ../data/equinix-chicago.dirA.20160121-130800.ports.npy \
#   --test  ../data/equinix-chicago.dirA.20160121-130900.ports.npy \
#   --save exp20_ip_rnn_10min_r1-p2-h2_rmin65_ru64_bs512_ep180 --rnn_hiddens 64 --port_hiddens 16 8 --hiddens 32 --batch_size 512 --n_epoch 200 --lr 0.0001 --regress_min 65 \
